...
ln -s liblibplant.2.1.1.dylib ./liblibplant.2.1.dylib
ln -s liblibplant.2.1.1.dylib ./liblibplant.2.dylib
ln -s liblibplant.2.1.1.dylib ./liblibplant.dylib
cd ../..
cp -r ../BUILD_DEB/myhome MyOpenSimulator/.
cp ../BUILD_DEB/MyOpenBagClient-build-Qt_4_8_4_Trolltech-Debug/MyOpenSimulator.app/Contents/MacOS/MyOpenSimulator MyOpenSimulator/bin/.
...
rm ./INSTALLER_MyOpenSimulator_MAC_3.tar.gz
tar vczf INSTALLER_MyOpenSimulator_MAC_3.tar.gz MyOpenSimulator
